...
function Home() {
  return (
    <>
            ...
            <div>
              <div className="lg:w-[570px]">
                <h1 className="text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]">
                  we help people to live a healthy life
                </h1>
                <p className="text-para">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Labore hic laboriosam excepturi iure eius rem quae quibusdam
                  voluptatibus omnis minus deserunt, praesentium nostrum
                  doloremque a minima voluptates sed unde inventore.
                </p>
              ...
              <div className="mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]">
                <div>
                  <h2 className="text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-700 font-headingColor">
                    30+
                  </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            <div className="py-[30px] px-5 ">
              ...
              <div className="mt-[30px]">
                ...
                <Link
                  to="/doctors"
                  className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none"
                >
      ...
      <section>
        <div className="container">
          <div className="flex items-container justify-between flex-col lg:flex-row">
            {/*feature content*/}
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                 ...
                 <li className="text_para">
                  3.View Our Physicians Who are Accepting New Patients. Use the Online Scheduling Tools to Select an Appointment time.
                 </li>
              </ul>
              <Link to="/">
